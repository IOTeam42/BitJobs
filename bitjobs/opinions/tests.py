...
class OpinionTests(TestCase):
    ...
    def setUpTestData(cls):
        for i in range(0, cls.n):
            ...
            cls.u[i].save()
        for i in range(0, cls.n):
            cls.c.append(Commission(orderer=cls.u[i], contractor=cls.u[(i+1)%cls.n]))
            cls.c[i].save()
    ...
    def test_add_correct(self):
        ...
        Opinion.addOpinion(self.u[0], self.c[0], "cow", 'P')
        Opinion.addOpinion(self.u[-1], self.c[-2], "sheep", 'N')
    ...
    def test_add_not_part(self):
        try:
            Opinion.addOpinion(self.u[0], self.c[1], "cow", 'P')
    ...
    def test_add_again(self):
        try:
            Opinion.addOpinion(self.u[0], self.c[0], "cow", 'P')
            Opinion.addOpinion(self.u[0], self.c[0], "sheep", 'N')
    ...
    def test_possible_give(self):
        self.assertEqual(Opinion.list_possible_give(self.u[0]).count(), 2)
        Opinion.addOpinion(self.u[0], self.c[0], "cow", 'P')
        self.assertEqual(Opinion.list_possible_give(self.u[0]).count(), 1)

    def test_possible_about(self):
        self.assertEqual(Opinion.list_possible_about(self.u[1]).count(), 2)
        Opinion.addOpinion(self.u[0], self.c[0], "cow", 'P')
        self.assertEqual(Opinion.list_possible_about(self.u[1]).count(), 1)